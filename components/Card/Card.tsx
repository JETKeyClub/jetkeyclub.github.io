...
export default function Card({ profileImage, name, quote}: CardProps){
    return <div className="flex flex-col items-center w-fit h-200">
        ...
        className="w-50 h-50 object-cover border-[0.5rem] border-solid border-borderblue-500 rounded-full relative top-25"
        />
        
        <blockquote className="p-5 pt-30 w-132 h-140 md:w-102 pb-25 rounded-t-[20%] flex flex-col gap-y-4 text-white text-center bg-keyblue-600">
